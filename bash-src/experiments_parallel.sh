...
# parallel --results /local/scratch/para_results -j$NUM_THREADS ./paralle_script.sh ::: 7 1
# 
# setup gdb gdb23   10  gdb gdb23   9 
# parallel --results /local/scratch/para_results -j$NUM_THREADS ./paralle_script.sh ::: 7 1
# 
# setup gdb gdb8   10  gdb gdb8   12 # This requires to run all experiments. !!!!!!!!!!!
# parallel --results /local/scratch/para_results -j$NUM_THREADS ./paralle_script.sh ::: `seq 30`
# 
...
parallel --results /local/scratch/para_results -j${NUM_THREADS} ./parallel_script.sh ::: `seq 30`
