...
import tl.knowledge.surrogate.knn.KNNPoolItem;
import tl.knowledge.surrogate.knn.KNNPoolUpdatePolicy;
 ...
 */
public class BuggyAddOncePhenotypic
implements KNNPoolUpdatePolicy
{
	@Override
										  ...
										  TreeSimilarityMetric metric, List<ReactiveDecisionSituation> dps, Object... extra)
	{
		...
		SimpleNichingAlgorithm.clearPopulation(sortedInds, filter, (SituationBasedTreeSimilarityMetric) metric, 0, 1);
