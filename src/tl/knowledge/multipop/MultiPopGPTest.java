...
public class MultiPopGPTest {
    ...
    public static void main(String[] args) {
        ...
        MultiPopReactiveGPHHProblem testProblem = (MultiPopReactiveGPHHProblem) state.evaluator.p_problem;
        ...
        for (int i = 0; i < numTrains; i++) {
            ...
            for (int j = 0; j < result.getSolutions().size(); j++) {
                testEvaluationModel[-1].evaluateOriginal(result.getSolutionAtGen(j), null,
