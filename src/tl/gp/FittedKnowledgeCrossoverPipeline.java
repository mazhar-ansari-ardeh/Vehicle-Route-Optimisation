...
public class FittedKnowledgeCrossoverPipeline extends GPBreedingPipeline
{
	...
	public FittedKnowledgeCrossoverPipeline() { parents = new GPIndividual[2]; }
	...
	public Object clone()
	{
		FittedKnowledgeCrossoverPipeline c = (FittedKnowledgeCrossoverPipeline)(super.clone());
...

	{
		...
		for(int q=start;q<n+start; /* no increment */)  // keep on going until we're filled up
		{
			...
			FittedCodeFragmentBuilder builder = new FittedCodeFragmentBuilder();;
