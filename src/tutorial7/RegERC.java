...
public class RegERC extends ERC
{
	...
	public static final double max = MultiValuedRegression.RANGE_MAX;

	public static final double min = MultiValuedRegression.RANGE_MIN;
			...
			Problem problem)
	{
		...
		((TripletData)input).setResult(value);
	}
