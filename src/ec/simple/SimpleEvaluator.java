...
//        for(int i = 0; i < 512; i++)
//        {
//            System.out.println("best:" + ": " + i + ", " + state.population.subpops[0].individuals[i].fitness.fitness());
//            if(state.population.subpops[0].individuals[i].fitness.fitness() < bestf)
//            {
//                best = i;
//                bestf = state.population.subpops[0].individuals[i].fitness.fitness();
//            }
//        }
//        System.out.println(best + ", " + state.population.subpops[0].individuals[best].fitness.fitness());
//        System.out.println(((GPIndividual)state.population.subpops[0].individuals[best]).trees[0].child.makeCTree(false, true, true));
//        System.out.println(((GPIndividual)state.population.subpops[0].individuals[best]).trees[0].child.makeGraphvizTree());
    }
