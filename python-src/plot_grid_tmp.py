...
filter = [
        ...
        #   r'ts_-1',
          r':ts_50',
        #   r'nrad_-1','gdb7.vs5.gdb7.vt4:gen_50',
                            # 'gdb7.vs5.gdb7.vt6:gen_50',
...
def plot_grid_output(test_fitness, experiment_path, boxplots=False, lcols=2, lfontsize=40, linewidth=19):
...
def plot_surr(output_folder=output_folder):
...
if __name__ == '__main__':
    # wdl(dirbase, experiments, inclusion_filter, exclusion_filter)
    # plot_surr()

    delete_alg(experiments=experiments, algortithm_to_delete='KnowledgeSource:clear_true')
